    ...
    const data = publicationList.map((publication_id, index) => {
        ...
        return (
            <div className="div_card_publication d-flex col-lg-10 p-3" key={index}>
                <div className="col-lg-1 photo_profile_card d-flex justify-content-center">
                    <img src={`${publication_id.avatar}`} className="col-lg-12 img_porfile"></img>
                </div>
        ...
        <div className="d-flex justify-content-center mt-3">
            <div className="d-flex col-lg-11 justify-content-center">
                <div className="col-lg-1">
                    <img className="col-lg-12" src={dataUser.avatar}></img>
                </div>
